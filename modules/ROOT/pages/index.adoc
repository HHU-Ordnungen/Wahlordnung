...
1. in <<_14_briefwahl, § 14 Absatz 2 Satz 1>> (Antragsfrist für Briefwahl) statt dem 21. Tag vor dem ersten Wahltag der 9. Tag vor der Eingangsfrist für die Briefwahlstimmen, die abweichende Frist nach § 14 Absatz 2 Satz 2 entfällt;
